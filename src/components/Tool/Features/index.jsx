      ...
      <ul>
        {data.map((item, index) => (
          <li className="feature_item" key={index}>
            ...
            <img src={item.checkBasic ? Checked : NoChecked} alt="checker icon" />
            <img src={item.checkUnlimited ? Checked : NoChecked} alt="checker icon" />
            <img src={item.checkPremium ? Checked : NoChecked} alt="checker icon" />
          </li>
        ))}
      </ul>
    </section>
